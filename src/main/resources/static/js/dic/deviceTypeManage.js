    ...
    layui.use('table', function(){
        ...
        tableIns=table.render({
            ...
            cols: [[
                ...
                ,{field:'name', title:'设备简称',align:'center'}
        ...
        //监听提交
        form.on('submit(deviceTypeSubmit)', function(data){
            // TODO 校验
            formSubmit(data);
            return false;
        });
...
function edit(data,title){
    ...
    //拉取最新的表格数据
    formSelects.data('deviceType', 'server', {
        ...
        success: function(id, url, searchVal, result){      //使用远程方式的success回调
            ...
            if(pid != null){
                ...
                formSelects.value('deviceType', assistAuditArry);
            }
...
function del(obj,id) {
    if(null!=id){
        layer.confirm('您确定要删除吗？', {
            ...
            $.post("/deviceType/del",{"id":id},function(data){
                if (data.code == 1) {
                    layer.alert(data.msg,function(){
                        layer.closeAll();
                        load(obj);
